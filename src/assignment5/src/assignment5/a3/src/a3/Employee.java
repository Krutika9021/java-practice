...
class Employee {
    ...
    void salary() {
        ...
        int k = 0;
        while (k < 3) {
            System.out.println(" DOES DO YOU HAVE DONE ANY EXTRA WORK \n\t1.PATENT \n\t2. OTHER BENEFICIAL WORK \n\t3.NO ");
    ...
    static void search(Programmer arr[], int key, int n) {
        for (int i = 0; i < n; i++) {
            if (arr[i].emp_id == key) {
                ...
                System.out.println(" EMPLOYEE WITH ID " + key + " NOT FOUND IN PROGRAMMERS ");
            }
        }
    }
}
    ...
    static void search(Teamlead arr[], int key, int n) {
        for (int i = 0; i < n; i++) {
            if (arr[i].emp_id == key) {
                ...
                System.out.println(" EMPLOYEE WITH ID " + key + " NOT FOUND IN TEAMLEAD ");
            }
        }
    }
}
        ...
        aa: do {
            ...
            switch (k) {
                ...
                case 5:
                    String des;
                    int key;
                    System.out.print("ENTER THE DESIGNATION OF EMPLOYEE YOU WANT TO SEARCH : ");
                    des = sc.next();
